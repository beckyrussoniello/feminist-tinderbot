class Swiper
  # TODO:
  # - UPDATE LOGGING TO INCLUDE ID, NAME, AGE, AND SWIPE VERDICT
  # - MORE TRAINING DATA
  # - INCORPORATE THRESHOLD LOGIC
  # - IF I'M USING CLASSIFIER, DO I NEED ANY CONCEPT OF SWIPE CRITERIA?
  # - HOW DO I WANT TO ORGANIZE THIS?  IF I MAKE A RAILS APP, I COULD HAVE AN INTERFACE FOR TRAINING (MANUAL SWIPING)
